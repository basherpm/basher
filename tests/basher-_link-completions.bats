...
@test "links zsh completions to prefix/completions" {
  create_package username/package
  ...
  assert_success
  assert [ "$(readlink $BASHER_PREFIX/completions/zsh/_exec)" = "${BASHER_PACKAGES_PATH}/username/package/completions/_exec" ]
}
